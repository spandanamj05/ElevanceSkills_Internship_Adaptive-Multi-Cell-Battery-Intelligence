...
String recommendation = "System Healthy";
...
if(sensorFault)
  recommendation = "Inspect Sensor Wiring";
else if(overVoltage)
  recommendation = "Disconnect Charger";
else if(weakCell)
  recommendation = "Replace Weak Cell";
else if(fluctuationFault)
  recommendation = "Check Cell Connections";
else if(adcFrozen)
  recommendation = "Check ADC Inputs";
else if(currentMode == SHUTDOWN)
...
Blynk.virtualWrite(V10, batteryHealth);
Blynk.virtualWrite(V11, riskLevel);
Blynk.virtualWrite(V12, recommendation);
